   	...
   	var App=function(){
	      ...
	      this.url={
	      	cdnUrl:cdnurl,
	        	...
	        	addAcount:weburl+"/partnerManagement/addAccount.html?type=0&pageTimeStap="+pageTimeStap,//添加账户  0 渠道 1 物流 2 车商
	        	editAcount:weburl+"/partnerManagement/sessionEditBankAccount.html?type=0&pageTimeStap="+pageTimeStap,//修改账户 0 渠道 1 物流 2 车商
	        	delAcount:weburl+"/partnerManagement/sessionDeleteBankAccount.html?type=0&pageTimeStap="+pageTimeStap,//删除缓存账号
	        	stopAcount:weburl+"/partnerManagement/sessionUpdateStatusBankAccount.html?type=0&pageTimeStap="+pageTimeStap,//修改状态
	        	lookAcount:weburl+"/partnerManagement/sessionGetBankAccount.html?type=0&pageTimeStap="+pageTimeStap,//查看账户
