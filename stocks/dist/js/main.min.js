...
var _Lists = __webpack_require__(60);
...
var _Stocks = __webpack_require__(58);
...
var calAverageLineData = __webpack_require__(15);
...
var isLowOpenAndHighClose = __webpack_require__(43);
var calProfitFromOneDay = __webpack_require__(42);
var calAverageLineData = __webpack_require__(15);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("52474275", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("2d589f4b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("6452e1ec", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
