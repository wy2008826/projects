...
var _Stocks = __webpack_require__(46);
...
exports.default = {
  ...
  created: function created() {
    var self = this;
    this.$http.get("/api/getAllCodeRecentT").then(function (res) {
      self.$data.nowT = res.body.lists.sort(function (prev, next) {
        return new Date(next.buyTime) - new Date(prev.buyTime);
      });
      var nowT = self.$data.nowT;

      for (var i = 0; i < nowT.length; i++) {
        var item = nowT[i];
        if (item.rate3 >= 8) {
          self.$data.count3 += 1;
        }
    ...
    this.$http.get("/api/selectSingleSunKeepedDays").then(function (res) {
...
var isLowOpenAndHighClose = __webpack_require__(39);
var calProfitFromOneDay = __webpack_require__(38);
var calAverageLineData = __webpack_require__(37);
...
exports.default = {
  ...
  computed: {
    ...
    allLowOpenAndHighClose: function allLowOpenAndHighClose() {
      var self = this;
      var sortData = self.$data.sortData;
      var suits = [];
      for (var i = 1; i < sortData.length; i++) {
        var recentData = sortData.slice(i - 1, i + 1);
        if (isLowOpenAndHighClose(recentData).isSuit) {
          var rates = calProfitFromOneDay(i, self.$data.sortData);

          var buyTimeClose = recentData[1][4];
          suits.push({
            time: recentData[1][0],
            buyTimeClose: buyTimeClose,
            rate3: rates.rate3,
            rate6: rates.rate6
          });
        }
  ...
  created: function created() {
    var self = this;
    this.$http.get("/api/getOneCodeAllT?code=" + self.code).then(function (res) {
...
var drawKLine = function () {
  function drawKLine(svg, data) {
    ...
    var start = this.length - 130 >= 0 ? this.length - 130 : 0;
...
module.exports = function (i, sortData) {
	...
	var laterDays3 = sortData.slice(i + 1, i + 4);
	var laterDays6 = sortData.slice(i + 1, i + 7);
	var laterDays9 = sortData.slice(i + 1, i + 10);
	var laterDays12 = sortData.slice(i + 1, i + 13);
	...
	for (var j = 0; j < laterDays3.length; j++) {
	...
	for (var _j = 0; _j < laterDays6.length; _j++) {
		if (laterDays6[_j][2] > max) {
			max = laterDays6[_j][2];
		}
	}
	max6 = max;

	for (var _j2 = 0; _j2 < laterDays9.length; _j2++) {
		if (laterDays9[_j2][2] > max) {
			max = laterDays9[_j2][2];
		}
	}
	max9 = max;

	for (var _j3 = 0; _j3 < laterDays12.length; _j3++) {
		if (laterDays12[_j3][2] > max) {
			max = laterDays12[_j3][2];
		}
	}
	max12 = max;
...
// module
exports.push([module.i, "\n.top_bar[data-v-15c0aa7d] {\n  line-height: 0.9rem;\n  font-size: 0.4rem;\n}\n.top_bar .search[data-v-15c0aa7d] {\n    font-size: 0.34rem;\n    margin: 0 0.1rem;\n    color: #ff0000;\n}\n.stock[data-v-15c0aa7d] {\n  display: flex;\n  background-color: #fff;\n  border: 0.012rem solid #f9f9f9;\n  line-height: 0.4rem;\n}\n.stock p[data-v-15c0aa7d] {\n    flex: 1;\n}\n.strategy_title[data-v-15c0aa7d] {\n  line-height: 1rem;\n  background-color: #fff;\n  border: 0.02rem solid #d8d8d8;\n  border-left: 0;\n  border-right: 0;\n}\n.strategy_ul li.high[data-v-15c0aa7d] {\n  background-color: #FF7256;\n}\n.strategy_ul li.low[data-v-15c0aa7d] {\n  background-color: #98FB98;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.strategy_title[data-v-79771185] {\n  text-align: center;\n  line-height: 0.6rem;\n  color: #456;\n}\ntable[data-v-79771185] {\n  width: 100%;\n  text-align: center;\n}\ntable tbody tr.high[data-v-79771185] {\n    background-color: #FF7256;\n}\ntable tbody tr.low[data-v-79771185] {\n    background-color: #98FB98;\n}\n.svg[data-v-79771185] {\n  display: block;\n  width: 7rem;\n  margin: 0.2rem auto;\n  border: 1px solid red;\n  background-color: #000;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("最近收T")]), _vm._v(" "), _c('ul', {
    staticClass: "clearfix strategy_ul"
  }, _vm._l((_vm.nowT), function(stock, index) {
    return _c('router-link', {
      staticClass: "stock text-center",
      class: _vm.lowOpenAndHighCloseRateClass(stock),
      attrs: {
        "tag": "li",
      ...
      domProps: {
        "textContent": _vm._s(stock.buyTime)
      }
    }), _vm._v(" "), _c('p', [_c('span', {
      domProps: {
      ...
      domProps: {
        "textContent": _vm._s(stock.rate3.toFixed(2) + '%')
      }
    }), _vm._v(" "), _c('p', {
      domProps: {
      ...
      domProps: {
        "textContent": _vm._s(stock.rate9.toFixed(2) + '%')
      }
    }), _vm._v(" "), _c('p', {
      domProps: {
      ...
      domProps: {
        "textContent": _vm._s(stock.pos.toFixed(2) + '%')
      }
    })])
  }))]), _vm._v(" "), _c('div', [_c('h4', {
    staticClass: "strategy_title text-center"
  }, [_vm._v("最近单阳不破")]), _vm._v(" "), _c('ul', {
    staticClass: "clearfix strategy_ul"
  }, _vm._l((_vm.nowKeepedDays), function(stock, index) {
    return _c('router-link', {
      staticClass: "stock text-center",
      class: _vm.lowOpenAndHighCloseRateClass(stock),
      attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('p', [_vm._v(_vm._s(_vm.code) + ":" + _vm._s(_vm.historyData.name))]), _vm._v(" "), _c('table', {
    staticClass: "table text-center"
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.suits), function(item) {
    return _c('tr', [_c('td', {
      domProps: {
      ...
      domProps: {
        "textContent": _vm._s(item[2])
      }
    }), _vm._v(" "), _c('td', {
      domProps: {
        "textContent": _vm._s(item[3])
      }
    }), _vm._v(" "), _c('td', {
      domProps: {
        "textContent": _vm._s(item[4])
      }
    })])
  }))]), _vm._v(" "), _c('div', [_c('p', [_c('span', {
    domProps: {
      "textContent": _vm._s(_vm.historyData.name)
    }
  }), _vm._v(" "), _c('span', {
    domProps: {
      "textContent": _vm._s(_vm.historyData.historyData.start)
    }
  }), _vm._v(" "), _c('span', {
    domProps: {
      "textContent": _vm._s(_vm.historyData.historyData.end)
    }
  })]), _vm._v(" "), _c('svg', {
    ref: "svg",
    staticClass: "svg",
    ...
    staticClass: "strategy_title"
  }, [_vm._v("所有的低开高走收益")]), _vm._v(" "), _c('table', [_vm._m(1), _vm._v(" "), _c('tbody', _vm._l((_vm.allLowOpenAndHighClose), function(item) {
    return _c('tr', {
      class: _vm.lowOpenAndHighCloseRateClass(item)
    }, [_c('td', {
      domProps: {
      ...
      domProps: {
        "textContent": _vm._s(item.rate3.toFixed(2))
      }
    }), _vm._v(" "), _c('td', {
      domProps: {
        "textContent": _vm._s(item.rate6.toFixed(2))
      }
    })])
  }))])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('td', [_vm._v("时间")]), _vm._v(" "), _c('td', [_vm._v("开盘")]), _vm._v(" "), _c('td', [_vm._v("最高")]), _vm._v(" "), _c('td', [_vm._v("最低")]), _vm._v(" "), _c('td', [_vm._v("收盘")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("时间")]), _vm._v(" "), _c('th', [_vm._v("3日内最高收益")]), _vm._v(" "), _c('th', [_vm._v("6日内最高收益")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
